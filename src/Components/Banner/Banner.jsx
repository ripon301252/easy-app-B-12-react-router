...
const Banner = () => {
    return (
        <div>
            <h1 className='md:text-5xl text-4xl text-center font-bold mt-14'>We Build <br /> <span className='text-[#8755ea]'>Productive </span> Apps</h1>
            <p className='text-center text-gray-400 md:text-sm text-xs my-6 md:mx-0 mx-2'>At EASY.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. <br /> Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
            ...
            <div className='bg-gradient-to-r from-[#5633e4] to-[#8755ea] md:py-12 py-6'>
                ...
                <div className='flex justify-evenly md:flex-row flex-col items-center mt-10'>
